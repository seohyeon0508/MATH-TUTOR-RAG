...
def extract_core_concepts_with_llm(texts):
    ...
    지켜야 할 규칙:
    1. 개념의 이름은 가장 보편적이고 간결한 핵심 용어를 사용해주세요. 
    예를 들어, '정비례 관계'나 '정비례의 개념' 대신 '정비례'를 사용하세요.
    ...
    **출력 형식:**
    추출한 모든 개념을 반드시 다음 JSON 형식에 맞춰 리스트로 반환해주세요.
    {"concepts": [{"name": "추출한 개념 이름", "definition": "생성한 한 문장 정의"}, ...]}
    """
