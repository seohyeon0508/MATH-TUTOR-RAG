...
2022 개정 교육과정 중학교 1학년 수학 데이터를 기반으로, 학생의 선수 지식을 진단하고 개념 간 관계를 학습 경로로 시각화하는 지능형 튜터링 시스템입니다.
...
- [ ] 중2, 중3 교육과정 데이터 추가
- [ ] Chroma DB 를 통한 벡터 검색을 활성화하여 의미 기반 개념 검색 강화
- [ ] 학습 분석 대시보드 (강점/약점 시각화)
- [ ] 문제 풀이 히스토리 및 오답 노트 기능
